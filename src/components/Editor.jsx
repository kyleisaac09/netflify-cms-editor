    ...
    return (
      <EditorWrap>
        ...
        <MarkdownWidget
          name="body"
          label="Body"
          onChange={body => this.setValue({ body })}
        />
        <ListWidget
          name="features"
          label="Features"
            ...
            <React.Fragment>
              <TextWidget
                ...
                value={
                  ...
                  entry.features[index].featureTitle
                }
                ...
                fields={(setLinkItemValue, linkIndex) => (
                  <React.Fragment>
                    <TextWidget
                      ...
                      label="Text"
                      onChange={featureLinkText =>
                        setLinkItemValue({ featureLinkText }, linkIndex)
                      }
                    />
                    <TextWidget
                      name="featureLinkPath"
                      label="Path"
                      onChange={featureLinkPath =>
                        setLinkItemValue({ featureLinkPath }, linkIndex)
                      }
                    />
                  </React.Fragment>
                )}
              ...
              <TextWidget
                ...
                value={
                  entry.features &&
                  entry.features[index] &&
                  entry.features[index].featureNotes
                }
